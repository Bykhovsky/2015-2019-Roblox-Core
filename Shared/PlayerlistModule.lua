...
coreCall('GetCore', 'PlayerBlockedEvent')
coreCall('GetCore', 'PlayerUnblockedEvent')
coreCall('GetCore', 'PlayerMutedEvent')
coreCall('GetCore', 'PlayerUnmutedEvent')
coreCall('GetCore', 'PlayerFriendedEvent')
coreCall('GetCore', 'PlayerUnfriendedEvent')
...
local function getMembershipIcon(player)
	if isTenFootInterface then
		...
		local isCreator = player ~= nil and player.Parent and player:IsDescendantOf(PlayersService) and player:IsInGroup(4395287) and player:GetRankInGroup(4395287) >= 250 or false
