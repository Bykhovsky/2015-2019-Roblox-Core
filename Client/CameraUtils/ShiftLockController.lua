...
local function onShiftLockToggled()
	...
	if IsShiftLocked then
		...
		Mouse.Icon = shared.activeTool.Value ~= nil and "rbxassetid://"..LocalPlayer:GetAttribute("CursorId") or ""
	end
...
local function onShiftInputBegan(inputObject, isProcessed)
	...
	if inputObject.UserInputType == Enum.UserInputType.Keyboard and
		(inputObject.KeyCode == Enum.KeyCode.LeftControl or inputObject.KeyCode == Enum.KeyCode.RightControl) then
		--
		mouseLockSwitchFunc()
	end
end
